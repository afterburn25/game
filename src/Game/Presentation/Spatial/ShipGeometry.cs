...
public static class ShipGeometry
{
    ...
    {
        Box(r, new(0, 0, 0), new(1.3f, .45f, 3.8f), m.Hull); Box(r, new(0, .33f, .25f), new(.76f, .28f, 1.65f), m.Glass);
        Wing(r, new(-1.35f, 0, .35f), 2.1f, .09f, m.Secondary, -13); Wing(r, new(1.35f, 0, .35f), 2.1f, .09f, m.Secondary, 13);
        Engines(r, new(0, 0, 2.08f), 2, .22f, m); if (detail) { Dish(r, new(0, .58f, -.8f), .48f, m); Lights(r, new(-.55f, .12f, -1.4f), new(.55f, .12f, -1.4f), m); }
    }
