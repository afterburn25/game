...
public sealed record UiOwnedColonySnapshot(int ColonyId, int BodyId, string ColonyName, string PlanetName,
    ...
    double RemainingDepositMaterials, double InitialDepositMaterials, string OutpostOperationsStatus,
        ...
        : _galaxy.Colonies
            ...
            .Select(colony =>
            {
                ...
                return new UiOwnedColonySnapshot(colony.Id, colony.PlanetaryBodyId ?? -1, colony.Name,
                    ...
                    outpost.RemainingDepositMaterials, outpost.InitialDepositMaterials, outpost.Status,
