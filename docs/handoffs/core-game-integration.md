...
24x time. Its campaign has a separate version1 envelope, independent backups and a
persistent ToolsUsed marker. Player save boundaries reject Developer state. Legacy
